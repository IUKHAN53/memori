<div>
    <section class="relative py-24 xl:py-32" id="">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="cards">
                <div class="card-body">
                    <div class="grid items-center grid-cols-1 gap-6 3 md:grid-cols-2 mb-5">
                        <div class="flex justify-start items-center flex-col md:flex-row gap-3">
                            ...
                            <div>
                                <div class="mobile-text-center font-medium text-lg">{{auth()->user()->name}}</div>
                                <div
                        ...
                        <div class="flex justify-end items-end">
                            <div
                                class="noti-bg border noti-border p-3 rounded-lg max-w-sm mx-auto my-8">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <img src="{{ asset('assets/images/flame.svg') }}" class="flame-icon" alt="Flame Icon" style="width: 16px; display: block; margin: auto; margin-bottom: 0.5rem;">
                                        <p style="text-align: center;">היי {{auth()->user()->first_name}}, {{__('all.thank_you_for_choosing')}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="flex flex-wrap justify-center w-full text-sm font-medium text-center border-b border-slate-200 dark:border-zink-500 nav-tabs">
                            <li class="group {{$tab == 'medallions' ? 'active' : ''}}">
                                <a href="javascript:void(0);" data-tab-toggle data-target="medallions"
                                   class="inline-block profile-tabs-pd py-2 text-base transition-all duration-300 ease-linear rounded-t-md text-slate-500 dark:text-zink-200 border-b border-transparent group-[.active]:text-custom-500 group-[.active]:border-b-custom-500 hover:text-custom-500 active:text-custom-500 dark:hover:text-custom-500 dark:active:text-custom-500 dark:group-[.active]:hover:text-custom-500 -mb-[1px]">
                                    {{ __('all.medallions')}}
                                </a>
                            </li>    
