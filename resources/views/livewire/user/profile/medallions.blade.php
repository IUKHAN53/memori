    ...
    <div class="{{!$list_screen ? 'hidden' : ''}}">
        <div class="mb-3">
            <div class="flex justify-between items-center">
                ...
                <button wire:click="showAddScreen()"
                        class="outline-btn font-bold py-2 px-4 rounded inline-flex items-center text-white gap-2">
                    <svg fill="#154190" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="10px"
                         viewBox="0 0 45.402 45.402" xml:space="preserve" stroke="#154190"><g id="SVGRepo_bgCarrier"
                                                                                              stroke-width="0"></g>
        ...
        <div class="relative overflow-x-auto sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    <th scope="col" class="px-3 py-3" style="font-weight: 400;">
                        {{ __('all.full_name') }}
                    </th>
                    <th scope="col" class="px-3 py-3" style="font-weight: 400;">
                        {{ __('all.picture') }}
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-3 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="{{route('profile.show',['id' => $profile->id])}}"
                               style="font-weight: 600; color: #154190; text-decoration: underline;">
                                {{$profile->full_name}}
                            </a>
                        </th>
                        <td class="px-3 py-4">
                                ...
                                <a href="#" wire:click="deleteProfile({{$profile->id}})"
                                   wire:confirm.prompt="{{ __('all.confirm_message') }}|DELETE">
                                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg" stroke="#d84242">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                           stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <path d="M10 12V17" stroke="#d84242" stroke-width="2" stroke-linecap="round"
                                                  stroke-linejoin="round"></path>
                                            <path d="M14 12V17" stroke="#d84242" stroke-width="2" stroke-linecap="round"
                                                  stroke-linejoin="round"></path>
                                            <path d="M4 7H20" stroke="#d84242" stroke-width="2" stroke-linecap="round"
                                                  stroke-linejoin="round"></path>
                                            <path
                                                d="M6 10V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V10"
                                                stroke="#d84242" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
        ...
        <form wire:submit.prevent="saveProfile">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
                <div>
                    ...
                    <select
                        ...
                        @foreach(['husband', 'wife', 'boyfriend', 'girlfriend', 'son', 'daughter', 'father', 'mother', 'brother', 'sister', 'grandfather', 'grandmother', 'grandson', 'granddaughter', 'uncle', 'aunt', 'nephew', 'niece', 'cousin', 'great_grandfather', 'great_grandmother', 'dog', 'cat', 'pet'] as $relationship)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
                <div class="relative inline-block group">
                    <label class="inline-block my-2" for="text_or_phrase">{{ __('all.profile_picture') }}</label>
                    <div class="flex ">
            ...
            <hr>
            <div class="my-3">
                <label for="text_or_phrase" class="inline-block my-2">{{ __('all.heading_text') }}</label>
                <input type="text" id="text_or_phrase" wire:model="form.heading_text"
                       class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                >
            </div>
            <p>{{ __('all.headline_text_description') }}</p>
            <h5 class="mt-8 mb-3">{{ __('all.obituary_information') }}</h5>
            <hr>
            <div class="my-3">
                <label class="inline-block my-2" for="link_to_obituary">{{ __('all.link_to_obituary') }}</label>
                <input type="text" id="link_to_obituary" wire:model="form.obituary_link"
                       class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                >
            </div>
            <div class="my-3">
                <label class="inline-block my-2" for="bio_info">{{ __('all.bio_information') }}</label>
                <textarea
                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                    id="bio_info" wire:model="form.bio" rows="3"></textarea>
            </div>
            <h5 class="mt-8 mb-4">{{ __('all.lifetimes') }}</h5>
            <hr>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
                <div>
                    <label for="dob"
            ...
            <h5 class="mt-8 mb-4">{{ __('all.location_details') }}</h5>
            <hr>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
                <div>
                    <label for="city"
            ...
            <h5 class="inline-block my-2">{{ __('all.cemetery_information') }}</h5>
            <hr>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
                <div>
