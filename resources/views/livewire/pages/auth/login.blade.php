...
<x-slot:title>
    ...
    <div class="mb-0 border-none shadow-none xl:w-2/3 card bg-white/70 dark:bg-zink-500/70 login-card">
        <div class="flex items-center justify-between gap-3">
                        <div class="grow">
                            <a href="#">
                                <img src="{{asset('logo-lg.png')}}" alt="" class="hidden h-6 dark:block logo-top">
                                <img src="{{asset('logo-lg.png')}}" alt="" class="block h-6 dark:hidden logo-top">
                            </a>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    <div class="text-center" style="margin-bottom: 1rem;">
                        <h3 class="mb-2 text-purple-500 dark:text-purple-500">{{ __('all.welcome_back') }}</h3>
                        <p class="text-slate-500 dark:text-zink-200">{{ __('all.sign_in_to_continue') }}</p>
                    </div>
                    <form wire:submit="login">
                        ...
                        <div class="mb-3">
                            ...
                            <x-text-input wire:model="form.password" id="password"
                                          type="password" required placeholder="{{__('all.password')}}"/>
                        ...
                        <div class="mt-10 text-center">
                            <p class="mb-0 text-slate-500 dark:text-zink-200">{{ __('all.dont_have_an_account') }}
