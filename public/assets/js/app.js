...
function setLanguage(lang) {
    if (document.getElementById("header-lang-img")) {
        if (lang === "en") {
            document.getElementById("header-lang-img").src = "assets/images/us.svg";
        } else if (lang === "sp") {
            document.getElementById("header-lang-img").src = "assets/images/es.svg";
        } else if (lang === "gr") {
            document.getElementById("header-lang-img").src = "assets/images/de.svg";
        } else if (lang === "it") {
            document.getElementById("header-lang-img").src = "assets/images/it.svg";
        } else if (lang === "ru") {
            document.getElementById("header-lang-img").src = "assets/images/ru.svg";
        } else if (lang === "ch") {
            document.getElementById("header-lang-img").src = "assets/images/china.svg";
        } else if (lang === "fr") {
            document.getElementById("header-lang-img").src = "assets/images/fr.svg";
        } else if (lang === "ar") {
            document.getElementById("header-lang-img").src = "assets/images/ae.svg";
        } else if (lang === "jp") {
            document.getElementById("header-lang-img").src = "assets/images/jp.svg";
        } else if (lang === "ar") {
            document.getElementById("header-lang-img").src = "assets/images/ae.svg";
        }
